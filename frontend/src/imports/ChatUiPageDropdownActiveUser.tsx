...
function YourApiKeyIsNotWorking() {
  return (
    <div className="absolute contents left-[130px] top-[309px]" data-name="Your API Key is not working?">
      <p className="absolute font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[28px] left-[calc(50%-8.5px)] text-[#1b2559] text-[16px] text-center text-nowrap top-[calc(50%-11px)] translate-x-[-50%] whitespace-pre">Your API Key is not working?</p>
      <div className="absolute flex inset-[50.47%_26.66%_48.67%_71.46%] items-center justify-center">
        <div className="flex-none h-[9.305px] rotate-[270deg] w-[5.487px]">
          <div className="relative size-full" data-name="Vector">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 10">
...
function ApiKeyCard() {
  return (
    <div className="absolute bg-white h-[640px] left-[calc(50%+13px)] overflow-clip rounded-[14px] shadow-[14px_27px_45px_4px_rgba(112,144,176,0.2)] top-[154px] translate-x-[-50%] w-[494px]" data-name="API Key card">
      <SaveButton />
      <Input1 />
      <p className="absolute font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-none left-[calc(50%-153px)] text-[#1b2559] text-[24px] text-nowrap top-[calc(50%-277px)] whitespace-pre">Enter your OpenAI API Key</p>
      <div className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[28px] left-1/2 text-[#718096] text-[16px] text-center top-[calc(50%-237px)] translate-x-[-50%] w-[398px]">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] left-[calc(50%-5.5px)] text-[#718096] text-[16px] text-center top-[calc(50%+33px)] translate-x-[-50%] w-[405px]">
        <ul className="mb-0">
          <li className="leading-[28px] list-disc list-inside ms-[24px]">
            <span>{`Make sure you have an `}</span>
            <span className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid underline">OpenAI</span>
            <span>{` account and a valid API key to use ChatGPT. We don't sell API keys.`}</span>
          </li>
        </ul>
        <p className="leading-[28px] mb-0">&nbsp;</p>
        <ul>
          <li className="leading-[28px] list-disc list-inside ms-[24px]">
            <span>{`Make sure you have your billing info added in `}</span>
            <a className="[text-decoration-skip-ink:none] [text-underline-position:from-font] cursor-pointer decoration-solid underline" href="https://platform.openai.com/account/billing/overview">
              <span className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid leading-[28px]" href="https://platform.openai.com/account/billing/overview">
                OpenAI Billing
              </span>
            </a>
            <span>{` page. Without billing info, your API key will not work.`}</span>
          </li>
        </ul>
      </div>
      <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[28px] left-1/2 text-[#718096] text-[14px] text-center top-[calc(50%+230px)] translate-x-[-50%] w-[352px]">*The app will connect to OpenAI API server to check if your API Key is working properly.</p>
      <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] absolute decoration-solid font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[28px] left-1/2 text-[#603cff] text-[14px] text-center text-nowrap top-[calc(50%-55px)] translate-x-[-50%] underline whitespace-pre">Get your API key from Open AI Dashboard</p>
...
function AlertError() {
  return (
    <div className="absolute bg-[#fde0d0] box-border content-stretch flex flex-col gap-[2px] h-[63px] items-center justify-center left-[calc(50%+0.5px)] p-[8px] rounded-[14px] top-[-63px] translate-x-[-50%] w-[575px]" data-name="Alert Error">
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[19px] leading-[16px] relative shrink-0 text-[#e31a1a] text-[16px] text-center w-[522px]">Invalid API key. Please make sure your API key is still working properly.</p>
    </div>
  );
}
...
function AlertSuccess() {
  return (
    <div className="absolute bg-[#c9fbd5] box-border content-stretch flex flex-col gap-[2px] h-[63px] items-center justify-center left-[calc(50%+0.5px)] p-[8px] rounded-[14px] top-[-63px] translate-x-[-50%] w-[443px]" data-name="Alert Success">
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[19px] leading-[16px] relative shrink-0 text-[#01b574] text-[16px] text-center w-[391px]">Success! You can start using Horizon Chat UI now!</p>
    </div>
  );
}
...
function AdminPages() {
  return (
    <div className="absolute contents left-[39px] top-[495px]" data-name="Admin Pages">
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*1)+(var(--transform-inner-height)*0)))] items-center justify-center left-[254px] top-[502px] w-[calc(1px*((var(--transform-inner-height)*1)+(var(--transform-inner-width)*0)))]" style={{ "--transform-inner-width": "20", "--transform-inner-height": "10" } as React.CSSProperties}>
...
export default function ChatUiPageDropdownActiveUser() {
  return (
    <div className="bg-white relative size-full" data-name="Chat UI Page Dropdown Active (User)">
      <Menu />
      <Layout />
      <Sidebar />
    </div>
